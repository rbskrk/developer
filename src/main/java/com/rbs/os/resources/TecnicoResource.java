...
import com.rbs.os.service.TecnicoService;
...
public class TecnicoResource {
	...
	public ResponseEntity<List<TecnicoDTO>> findAll() {
		 ...
		 * List<TecnicoDTO> listDTO = new
		 * ArrayList<>();
		 * 
		 * for(Tecnico obj : list) { listDTO.add(new TecnicoDTO(obj)); }
		 * 
		 * aqui menos verboso list.forEach(obj -> listDTO.add(new TecnicoDTO(obj)));
		 * 
		 * ou o que foi implementando
		 */
	}
